...
> G11 是 2026-09-10 用户看完三方对比后提的需求。G7 与 G11 的方案细节另记在 [TODO.md](TODO.md)，本表只记一句话与状态。
